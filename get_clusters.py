...
def main(load_dir, save_dir, sample_size=100000):
    
    
    with open(load_dir+'/'+'bert_train_stats.pkl', 'rb') as f:
        log = pickle.load(f)
        
    with open(load_dir+'/'+'bert_test_stats.pkl', 'rb') as f:
        test_log = pickle.load(f)
        
    with open(load_dir+'/'+'token_inputs.pkl', 'rb') as f:
    ...
    with open(save_dir+'/'+'clusters.pkl', 'wb') as f:
        pickle.dump(clusters, f)
    
    if not os.path.exists(save_dir+'/token_data'):
        os.makedirs(save_dir+'/token_data')
    ...
    with open(save_dir+'/token_data/sample_data.pkl', 'wb') as f:
        pickle.dump(token_input_data, f)
    
    with open(save_dir+'/token_data/easy_data.pkl', 'wb') as f:
        pickle.dump(cluster_regions['easy'][1], f)
    
    with open(save_dir+'/token_data/ambig_data.pkl', 'wb') as f:
        pickle.dump(cluster_regions['ambig'][1], f)
    
    with open(save_dir+'/token_data/hard_data.pkl', 'wb') as f:
...
if __name__ == "__main__":
    ...
    main(load_dir = 'results/full_train', save_dir= 'results/token_level', sample_size=50000)
